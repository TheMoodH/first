...
window.onload=function(){
	...
	var scrollphoto = feature.getElementsByTagName("div"); 
	function ScrollPhotoLeft(){ 
		if(scrollphoto[0].offsetWidth-feature.scrollLeft<=0){
			feature.scrollLeft-=scrollphoto[0].offsetWidth; 
		} 
		else{
			feature.scrollLeft++; 
		}
	}
	timer1=setInterval(ScrollPhotoLeft,speed); 
